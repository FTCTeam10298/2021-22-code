...
Basic:	    This is a minimally functional OpMode used to illustrate the skeleton/structure
            of a particular style of OpMode.  These are bare bones Tank Drive us.brainstormz.examples.
...
Eg: from the us.brainstormz.examples above:  tool, leftMotor, rightClawServo, rearLightSensor.

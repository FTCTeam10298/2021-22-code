...
//        robot.turnGoToPosition(target, 1.0, 0.5, this)
        ...
        while (true) {
            console.display(1, "absolute x " + robot.localizer.currentPositionAndRotation().x.toString())
            console.display(2, "absolute y " + robot.localizer.currentPositionAndRotation().y.toString())
            console.display(3, "absolute r " + (robot.localizer.currentPositionAndRotation().r * 57.2958).toString())

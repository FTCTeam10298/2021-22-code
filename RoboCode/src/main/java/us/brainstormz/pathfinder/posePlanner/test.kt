...
//
//fun main() {
////    val poly = Poly(Coordinate(1.0, 1.0), Coordinate(10.0, 10.0), Coordinate(5.0,5.0))
...
//        val obsGen = ObstructionGen(listOf())
//
//        val line = Line(Coordinate(0.0, 0.0), Coordinate(30.0, 30.0))
...
////            Obstruction(Poly(Coordinate(10.0, 10.0),
////                                    Coordinate(10.0, 20.0),
////                                    Coordinate(20.0, 20.0),
////                                    Coordinate(20.0, 10.0)))
//        val result = obstructions.fold<Obstruction, Pair<Obstruction, Pair<Coordinate, Line>>?>(null){ acc: Pair<Obstruction, Pair<Coordinate, Line>>?, it ->
...
//
//    private fun containsPoint(poly: Poly, p: Coordinate): Boolean {
...
//        var points = mutableListOf<Coordinate>()
//
//        val start = Coordinate(Random.nextDouble(6.0), Random.nextDouble(6.0))
//        for (i in 0..Random.nextInt(3, 5)) {
//
//            val new = Coordinate(Random.nextDouble(4.0), Random.nextDouble(4.0))
//
...
//    private val start = Coordinate(0.0, 0.0, 0.0)
//    private val end = Coordinate(10.0, 10.0, 0.0)
//    private var obstructions: List<Obstruction> =
////        listOf(Obstruction(Poly(Coordinate(6.519797831033332, 7.727695766206712, 0.0), Coordinate(3.808070865924204, 5.0588240052818865, 0.0), Coordinate(4.055833477091567, 3.0009006746074265, 0.0))),
////               Obstruction(Poly(Coordinate(2.895762025674081, 5.1004682898221, 0.0), Coordinate(9.074475200744146, 5.2907985702886755, 0.0), Coordinate(4.487713669422675, 3.6953173241440336, 0.0))),
////               Obstruction(Poly(Coordinate(6.629677988177396, 9.479500916380966, 0.0), Coordinate(8.302927274401915, 8.96710029016767, 0.0), Coordinate(9.7812744203991, 7.538503451029122, 0.0))))
//        listOf(
//            Obstruction(Poly(Coordinate(2.0, 3.0), Coordinate(3.5, 3.0), Coordinate(4.0, 8.0), Coordinate(4.0, 6.0))),
//                                                         Obstruction(Poly(Coordinate(5.0, 4.0), Coordinate(5.0, 2.0), Coordinate(7.0, 2.0), Coordinate(7.0, 4.0))),
//                                                         Obstruction(Poly(Coordinate(8.0, 7.0), Coordinate(8.0, 9.0), Coordinate(9.0, 9.0), Coordinate(9.0, 7.0)))
//        )
//
...
//    private var neighbors = listOf<Coordinate>()
//
//    private var path = listOf<Coordinate>()
//
